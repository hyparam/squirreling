...
describe('parseSql - WHERE clause', () => {
  it('should parse WHERE with equality', () => {
    const select = parseSelect('SELECT * FROM users WHERE age = 25')
  ...
  it('should parse WHERE with string literal', () => {
    const select = parseSelect('SELECT * FROM users WHERE name = \'John\'')
    expect(select.where).toEqual({
      type: 'binary',
      op: '=',
  ...
  it('should parse WHERE with comparison operators', () => {
    const select = parseSelect('SELECT * FROM users WHERE age > 18')
  ...
  it('should parse WHERE with AND', () => {
    const select = parseSelect('SELECT * FROM users WHERE age > 18 AND city = "NYC"')
    expect(select.where).toEqual({
      type: 'binary',
      op: 'AND',
      left: {
  ...
  it('should parse WHERE with OR', () => {
    const select = parseSelect('SELECT * FROM users WHERE age < 18 OR age > 65')
    expect(select.where).toEqual({
      type: 'binary',
      op: 'OR',
      left: {
  ...
  it('should parse WHERE with NOT', () => {
    const select = parseSelect('SELECT * FROM users WHERE NOT active')
    expect(select.where).toEqual({
      type: 'unary',
      op: 'NOT',
      argument: {
  ...
  it('should parse WHERE with parentheses', () => {
    const select = parseSelect('SELECT * FROM users WHERE (age > 18 AND age < 65)')
    expect(select.where).toEqual({
      type: 'binary',
      op: 'AND',
      left: {
  ...
  it('should parse WHERE with boolean literals', () => {
    const ast1 = parseSelect('SELECT * FROM users WHERE active = TRUE')
    ...
    const ast2 = parseSelect('SELECT * FROM users WHERE deleted = FALSE')
  ...
  it('should parse WHERE with NULL', () => {
    const select = parseSelect('SELECT * FROM users WHERE email = NULL')
    expect(select.where?.type).toBe('binary')
    if (select.where?.type === 'binary') {
  ...
  it('should parse WHERE with IS NULL', () => {
    const select = parseSelect('SELECT * FROM users WHERE email IS NULL')
    expect(select.where).toEqual({
      type: 'unary',
      op: 'IS NULL',
      argument: {
  ...
  it('should parse WHERE with IS NOT NULL', () => {
    const select = parseSelect('SELECT * FROM users WHERE email IS NOT NULL')
    expect(select.where).toEqual({
      type: 'unary',
      op: 'IS NOT NULL',
      argument: {
  ...
  it('should parse WHERE with IS NULL in complex expression', () => {
    const select = parseSelect('SELECT * FROM users WHERE email IS NULL AND age > 18')
    expect(select.where).toEqual({
      type: 'binary',
      op: 'AND',
      left: {
  ...
  it('should parse WHERE with IS NOT NULL in OR expression', () => {
    const select = parseSelect('SELECT * FROM users WHERE email IS NOT NULL OR phone IS NOT NULL')
    expect(select.where).toEqual({
      type: 'binary',
      op: 'OR',
      left: {
  ...
  it('should parse WHERE with LIKE', () => {
    const select = parseSelect('SELECT * FROM users WHERE name LIKE \'John%\'')
    expect(select.where).toEqual({
      type: 'binary',
      op: 'LIKE',
      left: {
  ...
  it('should parse WHERE with BETWEEN', () => {
    const select = parseSelect('SELECT * FROM users WHERE age BETWEEN 18 AND 65')
    expect(select.where).toEqual({
      type: 'binary',
      op: 'AND',
      left: {
  ...
  it('should parse WHERE with NOT BETWEEN', () => {
    const select = parseSelect('SELECT * FROM users WHERE age NOT BETWEEN 18 AND 65')
    expect(select.where).toEqual({
      type: 'binary',
      op: 'OR',
      left: {
  ...
  it('should parse WHERE with BETWEEN and strings', () => {
    const select = parseSelect('SELECT * FROM users WHERE name BETWEEN \'A\' AND \'M\'')
    expect(select.where).toEqual({
      type: 'binary',
      op: 'AND',
      left: {
  ...
  it('should parse WHERE with BETWEEN in complex expression', () => {
    const select = parseSelect('SELECT * FROM users WHERE age BETWEEN 18 AND 65 AND city = \'NYC\'')
    expect(select.where).toEqual({
      type: 'binary',
      op: 'AND',
      left: {
  ...
  it('should parse WHERE with BETWEEN and qualified column names', () => {
    const select = parseSelect('SELECT * FROM users WHERE users.age BETWEEN 18 AND 65')
    expect(select.where).toEqual({
      type: 'binary',
      op: 'AND',
      left: {
  ...
  it('should parse WHERE with IN subquery', () => {
    const select = parseSelect('SELECT * FROM orders WHERE user_id IN (SELECT id FROM users WHERE active = 1)')
    expect(select.where).toEqual({
      type: 'in',
      expr: {
        type: 'identifier',
  ...
  it('should parse WHERE with IN list of values', () => {
    const select = parseSelect('SELECT * FROM users WHERE name IN (\'Alice\', \'Bob\', \'Charlie\')')
    expect(select.where).toEqual({
      type: 'in valuelist',
      expr: {
        type: 'identifier',
  ...
  it('should parse WHERE with EXISTS subquery', () => {
    const select = parseSelect('SELECT * FROM orders WHERE EXISTS (SELECT * FROM users WHERE users.id = orders.user_id)')
    expect(select.where).toEqual({
      type: 'exists',
      subquery: {
        type: 'select',
  ...
  it('should parse WHERE with NOT EXISTS subquery', () => {
    const select = parseSelect('SELECT * FROM orders WHERE NOT EXISTS (SELECT * FROM users WHERE users.id = orders.user_id)')
    expect(select.where).toEqual({
      type: 'not exists',
      subquery: {
        type: 'select',
